...
class ALOISim(MultiAnnotatorDataset):
    def __init__(
        self,
        root: str,
        ...
        # Download data.
        self.x, self.y = fetch_openml(data_id=42396, data_home=root, cache=True, return_X_y=True)
        ...
        split_dict["train"], split_dict["valid"] = train_test_split(
            train, test_size=2000, random_state=0, stratify=self.y[train]
        )
